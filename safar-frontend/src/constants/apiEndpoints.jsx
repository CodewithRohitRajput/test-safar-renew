export const API_ENDPOINTS = {
  USERS: {
    ...
    INSTALINK_ENQUIRY: '/user/instalink-enquiry', 
  ...
  ADMIN: {
    ...
    GET_ALL_CUSTOMIZE_ENQUIRIES: '/admin/customize-enquiries',
    GET_ALL_INSTALINK_ENQUIRIES: '/admin/instalink-enquiries',
    UPDATE_LEAD_REMARK: '/admin/leads/remark',
    GET_ALL_ENQUIRIES: '/admin/enquiries',
    GET_HERO_SLIDES: '/admin/hero-slides',
    CREATE_HERO_SLIDE: '/admin/hero-slides',
    UPDATE_HERO_SLIDE: '/admin/hero-slides',
    DELETE_HERO_SLIDE: '/admin/hero-slides', 
  ...
  COMMON: {
    ...
    SUGGEST_ITINERARIES: "/common/itineraries/suggestions",
    SEARCH_ITINERARIES_BY_NAME_CITY: '/common/itineraries/search',
    GET_ALL_CATEGORIES: '/common/categories',
    GET_ALL_TERMS: '/user/terms_and_conditions',
    GET_ALL_POLICY: '/common/cancellation_policies',
    CUSTOM_CALLBACK: '/common/custom-callback',
    GET_HERO_SLIDES: '/common/hero_slides',
  },
  COMMENTS: {
  ...
  locations: {
    ...
    byId: (id) => `/admin/locations/${id}`,
    update: (id) => `/admin/locations/${id}`,
    destroy: (id) => `/admin/locations/${id}`,
    setItineraries: (id) => `/admin/locations/${id}/itineraries`,
  },
  REVIEWS: {
